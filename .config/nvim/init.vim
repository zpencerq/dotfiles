...
" Base16Bright Mode (Dark)
function! ColorBase16()
    let g:airline_theme='base16'
    color base16-bright
    IndentLinesEnable
endfunction

" Stop visual paste yank
...
" Let me switch off buffer without writing
set hidden
...
nmap <leader>e1 :call ColorBase16()<CR>
...
" Make 0 go to first character instead of bol
nnoremap 0 ^
nnoremap ^ 0

" More useful to go to the row AND column
nnoremap ' `
nnoremap ` '

" <Leader>" Surround word with "quotes"
map <Leader>" ysiw"
